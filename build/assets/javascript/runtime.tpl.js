...
templatizer["block-search-field"]["block-search"] = function tmpl_block_search_field_block_search(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    buf.push("<div" + jade.cls([ "block-search", data.modifiers ], [ null, true ]) + '><div class="block-search-header"><h3' + jade.attr("id", data.title_id, true, false) + ' class="block-search-title">' + jade.escape(null == (jade_interp = data.title) ? "" : jade_interp) + "</h3>");
...
templatizer["block-search-filters"]["block-search-filters"] = function tmpl_block_search_filters_block_search_filters(data) {
    ...
    buf.push(templatizer["block-search-filters"]["block-search"].call({
        block: function(buf) {
            ...
            buf.push('<div class="block-search-filters-secondary"><div id="js-facet-open" class="block-search-filters-secondary-item"></div><div id="js-facet-accessibility" class="block-search-filters-secondary-item"></div></div>');
        }
    }, data));
    return buf.join("");
};
...
templatizer["image-texte"]["image-texte"] = function tmpl_image_texte_image_texte(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    buf.push("<div" + jade.cls([ "image-texte", data.modifiers ], [ null, true ]) + '><div class="image-content"><img' + jade.attr("src", data.img.src, true, false) + ' class="image-content-img"/></div><div class="text-content component-text"><h3 class="text-content-title">' + jade.escape(null == (jade_interp = data.title) ? "" : jade_interp) + '</h3><p class="text-content-subtitle">' + jade.escape(null == (jade_interp = data.subtitle) ? "" : jade_interp) + '</p><p class="text-content-text">' + jade.escape(null == (jade_interp = data.text) ? "" : jade_interp) + "</p><a" + jade.attr("href", data.link.href, true, false) + ' class="text-content-link">' + jade.escape(null == (jade_interp = data.link.text) ? "" : jade_interp) + "</a></div></div>");
    return buf.join("");
};
