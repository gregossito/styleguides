...
templatizer["form"]["form-select"] = function tmpl_form_form_select(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    buf.push("<label" + jade.attr("for", data.id, true, false) + ' class="form-item-label">' + jade.escape(null == (jade_interp = data.label) ? "" : jade_interp) + "</label><select" + jade.attr("name", data.name, true, false) + jade.attr("id", data.id, true, false) + jade.attr("title", data.label, true, false) + jade.attr("required", data.required, true, false) + ' class="form-field">');
    (function() {
        var $$obj = data.items;
        if ("number" == typeof $$obj.length) {
            for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
...
templatizer["form"]["form-checkbox"] = function tmpl_form_form_checkbox(data) {
    ...
    (function() {
        ...
        if ("number" == typeof $$obj.length) {
            for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
                var item = $$obj[$index];
                buf.push("<div><label><input" + jade.attr("type", data.type, true, false) + jade.attr("name", data.name + (data.type === "checkbox" ? "[]" : ""), true, false) + jade.attr("value", item.value, true, false) + jade.attr("title", data.label, true, false) + jade.attr("checked", item.checked, true, false) + ' class="form-field"/>' + jade.escape(null == (jade_interp = item.text) ? "" : jade_interp) + "</label></div>");
            }
        } else {
            var $$l = 0;
            for (var $index in $$obj) {
...
templatizer["form"]["form-cgu"] = function tmpl_form_form_cgu(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    data.label += " *";
    buf.push('<div class="form-item-label">' + jade.escape(null == (jade_interp = data.label) ? "" : jade_interp) + '</div><div><label><input type="checkbox"' + jade.attr("title", data.label, true, false) + jade.attr("name", data.name, true, false) + ' value="true" required="required" class="form-field"/>' + jade.escape(null == (jade_interp = data.text) ? "" : jade_interp) + "&nbsp;");
    if (data.link) {
...
// jumbotron-slider.jade:button compiled template
templatizer["jumbotron-slider"]["button"] = function tmpl_jumbotron_slider_button(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    var data = JSON.parse(JSON.stringify(data || {}));
    var attributes = data.attributes || {};
    var modifiers = data.modifiers || [];
...
templatizer["jumbotron-slider"]["jumbotron-slider"] = function tmpl_jumbotron_slider_jumbotron_slider(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    buf.push("<div" + jade.attr("style", "background-image: url(" + data.image + ");", true, false) + jade.attr("title", "" + data.image + "", true, false) + jade.attr("id", data.id, true, false) + jade.cls([ "jumbotron-slider", data.modifiers ], [ null, true ]) + '><div class="jumbotron-slider-wrapper"><div class="layout-wrapper jumbotron-slider-content"><div class="jumbotron-slider-text">');
    if (data.href) {
        buf.push("<a" + jade.attr("href", data.href, true, false) + ' class="jumbotron-slider-link"><strong>' + jade.escape(null == (jade_interp = data.text) ? "" : jade_interp) + "</strong>" + jade.escape(null == (jade_interp = "    —  ") ? "" : jade_interp) + "<span>" + jade.escape(null == (jade_interp = data.hreftitle) ? "" : jade_interp) + '</span><i class="icon-arrow-small-right"></i></a>');
    } else {
        buf.push("<span>" + jade.escape(null == (jade_interp = data.text) ? "" : jade_interp) + "</span>");
    }
    buf.push("</div>");
    if (block) {
...
templatizer["municipal-site-list"]["municipal-site-list"] = function tmpl_municipal_site_list_municipal_site_list(data) {
    var block = this && this.block, attributes = this && this.attributes || {}, buf = [], jade_interp;
    buf.push('<div class="municipal-site-list-content"><p class="municipal-site-list-intro">' + jade.escape(null == (jade_interp = data.text) ? "" : jade_interp) + '</p><ul class="municipal-site-list">');
    (function() {
        var $$obj = data.items;
        if ("number" == typeof $$obj.length) {
            for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
                var item = $$obj[$index];
                buf.push('<li class="municipal-site-list-item"><div class="municipal-site-list-button">');
                if (item.button) {}
                var button = JSON.parse(JSON.stringify(item.button));
                buf.push(templatizer["municipal-site-list"]["button"](button));
                buf.push("</div></li>");
            }
        } else {
            var $$l = 0;
